...
class PegawaiController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pegawai.id LIKE ? OR 
				pegawai.id_pelayanan LIKE ? OR 
				pegawai.id_pengguna LIKE ? OR 
				pegawai.nama LIKE ? OR 
				pegawai.jabatan LIKE ? OR 
				pegawai.created_at LIKE ? OR 
				pegawai.updated_at LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("pegawai.id", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pegawai.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id_pelayanan","id_pengguna","nama","jabatan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","id_pelayanan","id_pengguna","nama","jabatan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'id_pelayanan' => 'required|numeric',
	...
	function delete($rec_id = null){
		...
		$db->where("pegawai.id", $arr_rec_id, "in");
