                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="peran">Peran <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-peran"  value="<?php  echo $this->set_field_value('peran',""); ?>" type="text" placeholder="Enter Peran"  required="" name="peran"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
