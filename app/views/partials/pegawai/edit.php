                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_pelayanan"  value="<?php  echo $data['id_pelayanan']; ?>" type="number" placeholder="Enter Id Pelayanan" step="1"  required="" name="id_pelayanan"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_pengguna"  value="<?php  echo $data['id_pengguna']; ?>" type="number" placeholder="Enter Id Pengguna" step="1"  required="" name="id_pengguna"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
