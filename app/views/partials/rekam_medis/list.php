                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-anamnesis"> Anamnesis</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("rekam_medis/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-tanggal">
                                                        <span  data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['tanggal']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("rekam_medis/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tanggal" 
                                                    ...
                                                    <td class="td-anamnesis">
                                                        <span  data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("rekam_medis/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="anamnesis" 
                                                            data-title="Enter Anamnesis" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="textarea" 
                                                            data-mode="popover" 
